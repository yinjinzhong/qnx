...
IS_WINDOWS = $(findstring win32,$(QNX_HOST))
ifneq ($(IS_WINDOWS),)
#
# The Windows maximum command line length is too small to allow us
...
objlist+= $(o)
cmdlist+=$$(if $$(word 800, $$(objlist)), $$(ARPREF) $$(AROPTS) $$@ $$(objlist) $$(ARPOST)$$(NEWLINE) $$(eval $(reset_objlist)))
endef
objlist:=
cmdlist:=
define CREATE_AR 
  ...
  $(cmdlist)
  $(if $(objlist),$(ARPREF) $(AROPTS) $@ $(objlist) $(ARPOST))
  $(POSTCREATE_AR)
endef
endif
...
$(PWD)/libc$(IMAGE_SUFF_SO): libc_cut.a $(PWD)/libcS.a
	$(ARPREF) $(AROPTS) libc.a ../../../stdio/$(CPU)/$(STDIO_DIR)/printf.o $(ARPOST)
	$(TARGET_BUILD)
	$(RM_HOST) libc.a
