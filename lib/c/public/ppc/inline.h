...
#define get_sreg(index)	({unsigned __val; __asm__ __volatile__( "mfsrin %0,%1" : "=r" (__val) : "r" (index) ); __val; })
#define set_sreg(index,val) __asm__ __volatile__( "mtsrin %1,%0" : : "r" (index), "r" (val) )
