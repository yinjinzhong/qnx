...
#ifdef _lint
#define __va_start_stdarg(__p1,__p2)  (__p1 = (va_list)&__p2)
#define __va_arg(__p1, __p2)          (*(__p2 *)__p1)
#define __va_end(__p1)
#define __va_copy(__d,__s)            (__d = __s)
#else
#define __va_start_stdarg(__p1,__p2)  __builtin_stdarg_start(__p1,__p2)
#define __va_arg(__p1, __p2)          __builtin_va_arg(__p1,__p2)
#define __va_end(__p1)                __builtin_va_end(__p1)
#define __va_copy(__d,__s)            __builtin_va_copy(__d,__s)
#endif
#endif
...
/* __SRCVERSION("compiler_gnu.h $Rev: 154597 $"); */
