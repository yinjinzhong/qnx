...
#if __STDC__-0 > 0 && !defined(__STDC_VERSION__) && ((!defined(_POSIX_C_SOURCE) && !defined(_POSIX_SOURCE)) || (_POSIX_C_SOURCE+0 >= 200112)) && (!defined(_XOPEN_SOURCE) || (_XOPEN_SOURCE+0 >= 600))
