...
int vfwscanf(struct _Filet *_Restrict, const wchar_t *_Restrict, __va_list);
int vswscanf(const wchar_t *_Restrict, const wchar_t *_Restrict, __va_list);
int vwscanf(const wchar_t *_Restrict, __va_list);
...
int vfwprintf(struct _Filet *, const wchar_t *, __va_list);
...
using std::wcstod; using std::wcstoul; using std::wcsstr;
...
/* __SRCVERSION("wchar.h $Rev: 153052 $"); */
