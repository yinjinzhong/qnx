...
struct _spawnattr;
extern int posix_spawnattr_getschedpolicy(struct _spawnattr *__attr, int *__schedpolicy);
extern int posix_spawnattr_setschedpolicy(struct _spawnattr *__attr, int __schedpolicy);
extern int posix_spawnattr_getschedparam(struct _spawnattr *__attr, struct sched_param *__schedparam);
extern int posix_spawnattr_setschedparam(struct _spawnattr *__attr, struct sched_param *__schedparam);
#endif
#if defined(__EXT_QNX)
