...
#define ldds(__seg)		((void)({_Uint16t __tmp = (__seg); __asm__ ( "movw %0,%%ds": :"rm" (__tmp)); }))
#define ldes(__seg)		((void)({_Uint16t __tmp = (__seg); __asm__ ( "movw %0,%%es": :"rm" (__tmp)); }))
#define ldfs(__seg)		((void)({_Uint16t __tmp = (__seg); __asm__ ( "movw %0,%%fs": :"rm" (__tmp)); }))
#define ldgs(__seg)		((void)({_Uint16t __tmp = (__seg); __asm__ ( "movw %0,%%gs": :"rm" (__tmp)); }))
#define ldesp(__esp)	((void)({__asm__ ( "movl %0,%%esp": :"g" (__esp)); }))
...
#define restore(__fl)	((void)({__asm__ __volatile__ ("push %0\n\tpopfl": : "rm" (__fl): "cc"); }))
