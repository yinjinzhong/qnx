...
#define	__va_start_stdarg(ap, last) (ap = ((char *)&(last) + __va_align(last)))
#define __va_arg(ap, type)  		((type *)((ap+=__va_align(type))-__va_align(type)))[0]
...
#define __va_start_stdarg(ap,pn) ((ap)[0]=(char __far *)&pn+\
    ((sizeof(pn)+sizeof(int)-1)&~(sizeof(int)-1)),(void)0)
#define __va_arg(ap,type)     ((ap)[0]+=\
    ((sizeof(type)+sizeof(int)-1)&~(sizeof(int)-1)),\
    (*(type __far *)((ap)[0]-((sizeof(type)+sizeof(int)-1)&~(sizeof(int)-1)))))
#define __va_end(ap)          ((ap)[0]=0,(void)0)
#else
typedef char *__va_list[1];

#define __va_start_stdarg(ap,pn) ((ap)[0]=(char *)&pn+\
    ((sizeof(pn)+sizeof(int)-1)&~(sizeof(int)-1)),(void)0)
#define __va_arg(ap,type)     ((ap)[0]+=\
    ((sizeof(type)+sizeof(int)-1)&~(sizeof(int)-1)),\
