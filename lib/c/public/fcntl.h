...
#if defined(_QNX_SOURCE) || (!defined(NO_EXT_KEYS) && !defined(_POSIX_C_SOURCE))
...
extern int _vopen(const char *__path, int __oflag, int __sflag, __va_list __ap);
...
/* __SRCVERSION("fcntl.h $Rev: 156647 $"); */
