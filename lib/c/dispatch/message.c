...
// types if the NOLOCK flag was specified to _dispatch_create(). This is 
// used by Proc, where we know the message vector will never change.
//
...
__SRCVERSION("message.c $Rev: 153052 $");
