...
EXT LINK3_HDR 				intrevent_pending;
...
EXT volatile unsigned char	queued_event_priority;
EXT LINK3_HDR 				intrevent_free;
EXT struct intrspin     	intrevent_lock;
EXT unsigned				num_intrevents		INIT1(200);
EXT unsigned				grow_intrevents;
EXT volatile unsigned		queued_intrevents;
...
EXT void					(rdecl *adjust_priority)(THREAD *thp, int prio, DISPATCH *dpp);
...
/* __SRCVERSION("externs.h $Rev: 156323 $"); */
