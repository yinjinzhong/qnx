...
#define _TRACE_VTH_EMIT_CREATE(vt) \
if (trace_masks.vth_mask&_NTO_TRACE_VTHCREATE)  vth_em_cd(vt, _TRACE_THREAD_CREATE, _TRACE_PR_TH_CREATE_VT);
#define _TRACE_VTH_EMIT_DESTROY(vt) \
if (trace_masks.vth_mask&_NTO_TRACE_VTHDESTROY) vth_em_cd(vt, _TRACE_THREAD_DESTROY, _TRACE_PR_TH_DESTROY_VT);
#define _TRACE_VTH_EMIT_STATE(vt,s) \
if (trace_masks.vth_mask&_NTO_TRACE_VTH ## s)   vth_em_st(vt, STATE_ ## s);
...
/* __SRCVERSION("kertrace.h $Rev: 153052 $"); */
