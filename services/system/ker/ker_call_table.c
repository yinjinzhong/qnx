...
#define _TRACE_TESTARGRET(c)  ((((c)->syscall&(0x3<<12))==(0x3<<12)))
#define _TRACE_TESTARGSTAT(c) ((((c)->syscall&(0x3<<12))!=(0x1<<12)))
#define _TRACE_TESTARGERR(c)  (!((c)->flags&_NTO_TF_KERERR_SET)&&_TRACE_TESTARGSTAT(c))
...
__SRCVERSION("ker_call_table.c $Rev: 153052 $");
