...
#endif
		/* clear bits */
		set_spr( PPCBKE_SPR_DBSR, PPCBKE_DBSR_DAC1R );
...
#endif
		/* clear bits */
		set_spr( PPCBKE_SPR_DBSR, PPCBKE_DBSR_DAC1W );
...
#endif
			/* clear bits */
			set_spr( PPCBKE_SPR_DBSR, PPCBKE_DBSR_DAC2R );
			match = _DEBUG_BREAK_RDM;
			*pflags |= _DEBUG_FLAG_TRACE_RD;
		}
...
#endif
			/* clear bits */
			set_spr( PPCBKE_SPR_DBSR, PPCBKE_DBSR_DAC2W );
			match = _DEBUG_BREAK_WRM;
			*pflags |= _DEBUG_FLAG_TRACE_WR;
		}
	}
