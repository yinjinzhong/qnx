...
#define EXTERN_BLOCK(which)											\
	...
	extern void		flush_vaddr_##which(uintptr_t);					\
...
unsigned					num_tlb;
uint8_t						perm_tlb_mapping[32*4*4];
...
tlbop_get_wired(void) {
	return *(uint8_t *)PPCBKE_RANDOM_BASE;
}
