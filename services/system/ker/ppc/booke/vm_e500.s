...
routine_start write_entry_e500, 1
	# R3 - tlb
	# R4 - idx
...
.endif
	...
	mtmsr	%r11
	blr
routine_end write_entry_e500

routine_start read_entry_e500, 1
	# R3 - tlb
	# R4 - idx
	# R5 - struct ppcbke_tlb *
...
.endif
	...
	blr
routine_end read_entry_e500

routine_start read_raw_e500,1
	# R3: tlb
	# R4: idx
	# R5: void *
...
1:
	...
	blr
routine_end read_raw_e500

routine_start flush_all_e500, 1
...
1:
	...
	isync
	blr
routine_end flush_all_e500

routine_start flush_asid_e500, 1
	lwz		%r5,tlbinfo@sdarel(%r13)
	lwz		%r12,num_tlb@sdarel(%r13)
...
routine_start check_perm_e500,0
...
1:
	...
	cmplwi	%r30,0
	beq		99f		# no match
	rlwinm	%r3,%r30,56-32+1,27,30	# extract size field (times two)
	loadi	%r4,0x400
	slw		%r4,%r4,%r3
	lwz		%r3,4(%r31)
	subi	%r4,%r4,1
