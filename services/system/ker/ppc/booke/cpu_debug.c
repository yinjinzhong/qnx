...
#ifdef DEBUG_DEBUG
kprintf("fault %d at %x MSR %x DBCR0 %x DBSR %x\n", info->si_fltno, KIP(thp), thp->reg.msr, get_spr( PPCBKE_SPR_DBCR0 ), get_spr( PPCBKE_SPR_DBSR ) );
#endif
