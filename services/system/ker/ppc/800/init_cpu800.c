...
static const struct trap_entry ppc_traps[] = {
	...
	{PPC_EXC_INSTR_ACCESS, __exc_instr_access, &__common_exc_entry},
	{PPC_EXC_DATA_ACCESS, __exc_data_access800, &__common_exc_entry},

	{PPC800_EXC_ID_ITLB_ERR, __exc_instr_access, &__common_exc_entry},
...
__SRCVERSION("init_cpu800.c $Rev: 153052 $");
