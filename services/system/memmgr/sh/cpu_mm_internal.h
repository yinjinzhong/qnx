...
#define CPU_SYSTEM_HAVE_MULTIPLE_PAGESIZES  1
...
#define CPU_ZERO_PAGE(addr, len, mm) ((void)({ 			\
...
//RUSH3: Check to see which of these macros are used
#define	MEM_COLOR_MASK	colour_mask_shifted
#define MEM_SIZECOLOR	(MEM_COLOR_MASK+__PAGESIZE)
#define	MEM_GETCOLOR(x)	((uint32_t)x&MEM_COLOR_MASK)
#define MEM_ADDCOLOR(addr,color) ((MEM_GETCOLOR(addr)>color)?((addr+MEM_SIZECOLOR)&~MEM_COLOR_MASK)|color:(addr&~MEM_COLOR_MASK)|color)
...
/* __SRCVERSION("cpu_mm_internal.h $Rev: 153052 $"); */
