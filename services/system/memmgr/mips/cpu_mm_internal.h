...
// Whether the system has memory colours, variable sized pages
	...
	#define CPU_SYSTEM_HAVE_MULTIPLE_PAGESIZES	0
#else
 ...
 */
	...
	#define PTE_PADDR(pte)		((((paddr_t)((pte) & MIPS_TLB_LO_PFNMASK)) << pfn_topshift) | ((pte & 0x80000000) ? 0xe000000000 : 0))
...
/* __SRCVERSION("cpu_mm_internal.h $Rev: 157044 $"); */
