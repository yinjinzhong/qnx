...
/*
 * For SMP we enable the CCR.SNM bit which means we have no colour issues
 */
#define SYSP_COLOR_MASK				0
#define SYSP_SIZECOLOR				0
#define SYSP_GETCOLOR(x)			0
#define SYSP_ADDCOLOR(addr,color)	(addr)
#else
#define SYSP_COLOR_MASK _BITFIELD32L(12,0x3)
#define SYSP_SIZECOLOR  _ONEBIT32L(14)
...
/* __SRCVERSION("cpu_sh.h $Rev: 153052 $"); */
