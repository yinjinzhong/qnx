...
struct kdebug_info {
	...
	unsigned						(*get_inkernel)(void);
	const struct kdebug_private		*kdbg_private;
	unsigned						(*vaddr_to_paddr)(struct kdebug_entry *entry, _Uintptrt *vaddr, unsigned *size);
...
/* __SRCVERSION("kdebug.h $Rev: 153052 $"); */
