 ...
 * Args: Pointer to an 'mempart_id_t'
*/ 
#define DCMD_PROC_GET_MEMPART_LIST	__DIOTF(_DCMD_PROC, __PROC_SUBCMD_PROCFS + 30, mempart_list_t)
 ...
 * Args: Pointer to an 'mempart_id_t'
*/ 
#define DCMD_PROC_ADD_MEMPARTID	__DIOT(_DCMD_PROC, __PROC_SUBCMD_PROCFS + 31, mempart_id_t)
#define DCMD_PROC_DEL_MEMPARTID	__DIOT(_DCMD_PROC, __PROC_SUBCMD_PROCFS + 32, mempart_id_t)
#define DCMD_PROC_CHG_MEMPARTID	__DIOT(_DCMD_PROC, __PROC_SUBCMD_PROCFS + 33, mempart_id_t)
...
/* __SRCVERSION("procfs.h $Rev: 156323 $"); */
