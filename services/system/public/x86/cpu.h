...
typedef struct x86_tss_entry {
	_Uint32t	back_link,
				...
				*esp,
				...
				ldt, 
				iomap0,
				iomap1; /* I/O map is not used by QNX! */
} X86_TSS;
...
#define X86_PDE_NX				0x8000000000000000
...
#define X86_MTRR_PHYSBASE_BASE_MASK		0x0000000ffffff000
#define X86_MTRR_PHYSMASK_RANGE_MASK	0x0000000ffffff000
