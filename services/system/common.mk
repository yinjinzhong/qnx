...
EXTRA_MODULES_ion=ker/cisco memmgr/cisco pathmgr/cisco

ADDON_MODULE_DIRS=ker/aps memmgr/apm partmgr $(EXTRA_MODULES_$(BUILDENV)) $(EXTRA_MODULES)
...
CHECK_FOR_UNDEFS=test -z `nto$(CPU)-nm -u $(FULLNAME) | $(STRIP_ALLOWED_UNRESOLVEDS)` \
	|| (echo "Unresolved symbols in $(FULLNAME):"; nto$(CPU)-nm -u $(FULLNAME) | $(STRIP_ALLOWED_UNRESOLVEDS); rm $(FULLNAME); exit 1)

STRIP_ALLOWED_UNRESOLVEDS=grep -F -v -e _gp -e _SDA_BASE_ -e _SDA2_BASE -e _end -e module_list_start -e module_list_end
endif


all: $(FULLNAME) $(MODULE_LIBS)
...
ifeq ($(strip $(filter-out o be le 600, $(subst -, , $(subst ., ,$(VARIANT1))))),)
